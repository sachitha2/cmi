  ...
  <div id="content" class="app-content box-shadow-z0" role="main">
    ...
    <div ui-view class="app-body" id="view">
		<?php $main->modal() ?>
          ...
          <br>
          <center> 
            <button type="button" class="btn btn-primary btn-lg" onClick="window.location.assign('PDF/purchasedItemsTodayPDF.php')"  style="width: 40%;margin-bottom: 5px;">Get PDF Report</button>
          </center>
