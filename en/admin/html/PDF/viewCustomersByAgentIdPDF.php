...
$agentId = htmlspecialchars($_GET["agentId"]);

$arr = $DB->select("customer","WHERE agentid = ".$agentId);

$pdf = new FPDF('L','mm','A4');
$pdf->AddPage("L",'A4');
$pdf->SetFont('Times','B',18);
$pdf->Cell('',10,"Customers by Agent ID(".$Date.')','','',"C");
...
$pdf->Output('',"Customers by Agent ID(".$Date.').pdf',true);
