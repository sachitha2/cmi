...
$arr = $DB->select("cost","WHERE (WEEK(date) = WEEK(CURDATE()) && MONTH(date) = MONTH(CURDATE()) && YEAR(date) = YEAR(CURDATE()))");

$pdf = new FPDF('P','mm','A4');
$pdf->AddPage("p",'A4');
$pdf->SetFont('Times','B',18);
$pdf->Cell('',10,"Expenses(".$week.')','','',"C");
...
$pdf->Output('',"Expenses(".$week.').pdf',true);
