  ...
  <div id="content" class="app-content box-shadow-z0" role="main">
    ...
    <div class="container h-100" id="cStage">
    		...
    		<center>
    			...
    			<button type="button" class="btn btn-primary btn-lg" onClick="ajaxCommonGetFromNet('subPages/collectionAreas.php?type=month','cStage')"  style="width: 40%;margin-bottom: 5px;">Area</button>
