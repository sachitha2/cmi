...
<!-- ############ LAYOUT START-->
  ...
  <div id="content" class="app-content box-shadow-z0" role="main">
    ...
    <div class="container h-100" id="cStage">
    		...
    		<center> 
				<a href="createCustomer.php"><button type="button" class="btn btn-primary btn-lg"  style="width: 40%;margin-bottom: 5px;background-image: url(http://localhost/shop/en/admin/assets/icons/add.png);background-repeat: no-repeat;width: 200px;height: 200px;background-size: 200px 200px;">Find | ADD </button></a>
<!--				<button type="button" class="btn btn-primary btn-lg" onClick="ajaxCommonGetFromNet('subPages/addACustomer.php','cStage')"  style="width: 40%;margin-bottom: 5px;">ADD | Without NIC</button>-->
				<button type="button" class="btn btn-primary btn-lg" onClick="ajaxCommonGetFromNet('subPages/customers.STE.php','cStage')"  style="width: 40%;margin-bottom: 5px;background-image: url(http://localhost/shop/en/admin/assets/icons/add.png);background-repeat: no-repeat;width: 200px;height: 200px;background-size: 200px 200px;">Edit</button>
