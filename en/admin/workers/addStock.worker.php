...
//print_r($postData);
$conn->query("INSERT INTO `stock` (`id`, `itemid`, `bprice`, `sprice`, `amount`,`ramount`, `adate`, `mfd`, `exdate`, `status`,`marketPrice`,`cashPrice`,`type`) VALUES (NULL, '$id', '$bPrice', '$sPrice', '$amount','$amount', curdate(), '$mfd', '$exDate', '1','{$_GET['mPrice']}',$cPrice,0);");
